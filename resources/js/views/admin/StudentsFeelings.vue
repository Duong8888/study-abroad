<template>
    <div>
        <TeamView :titleShow="false" :items="items"></TeamView>
        <div class="container">
            ...
            <table class="table table-bordered">
                ...
                <tr v-for="(item, index) in items" :key="index">
                    <td>{{ item.name }}</td>
                    <td><img :src="item.avatar" alt="Image" class="table-image"></td>
                    <td>
                        <div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" v-model="currentItem.name" id="itemName"
                        ...
                        <div class="form-group">
                            <label for="itemImage" class="d-flex justify-content-center">
                                <svg v-if="!currentItem.avatar" xmlns="http://www.w3.org/2000/svg" width="100"
                                ...
                                <img v-if="currentItem.avatar" :src="currentItem.avatar" alt="Preview"
                                     class="preview-image">
                            </label>
...
export default {
    ...
    computed: {
        ...mapGetters('team', ['teamAll','statusBtn'])
    },
    created() {
        this.fetchTeam();
    },
    ...
    methods: {
        ...mapActions('team', ['fetchTeam', 'addTeam', 'updateTeam', 'deleteTeam']),
        openModal(isEdit, index = null) {
            this.isEdit = isEdit;
            if (isEdit && index !== null) {
                this.currentItem = {...this.items[index], index};
            } else {
                this.currentItem = {name: '', image: '', avatarFile: null, id: ''};
            }
        ...
        async saveItem() {
            try {
                ...
                if (this.isEdit) {
                    ...
                    await this.updateTeam({data: formData, toast: this.$toast});
                } else {
                    await this.addTeam({data: formData, toast: this.$toast});
                }
        ...
        async confirmDelete() {
            ...
            await this.deleteTeam({id: this.idDelete, toast: this.$toast});
            await this.fetchTeam();
        },
